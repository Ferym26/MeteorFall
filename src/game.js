...
function Player() {
    ...
    this.update = function (e) {
        const margin = (window.innerWidth - playerW) / 2;
...
function collision() {
    ...
    for(var i = 0; i < enemies.length; i++) {
        if (player.posY < enemies[i].posY + enemies[i].size &&
            player.posX + player.size > enemies[i].posX &&
            player.posX < enemies[i].posX + enemies[i].size) {
